...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['regenerate_captcha'])) {
    ...
    elseif (!$student_no || !$name || !$course || !$year_level || !$username || !$password || !$confirm || !$email) {
        ...
        if ($stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->get_result()->num_rows > 0) {
                ...
                if ($stmt->execute()) {
                    ...
                    $stmt2 = $conn->prepare("INSERT INTO users (name, username, password, role, student_id, email) VALUES (?,?,?,'student',?,?)");
                    $stmt2->bind_param("sssis", $name, $username, $hashed, $new_student_id, $email);
                    if ($stmt2->execute()) {
                ...
                <form method="POST" id="regForm">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" name="student_no" id="student_no" class="form-control"
                                    ...
                                    value="<?= htmlspecialchars($_POST['student_no'] ?? '') ?>" maxlength="18"
                                    oninput="validateStudentNo(this)" required>
                            </div>
                            ...
                            <div class="input-wrap select-wrap">
                                ...
                                <select name="course" class="form-control" required>
                                    ...
                                    <?php foreach (['BSIT', 'BSCS', 'BSA', 'BSBA', 'BSHM'] as $c): ?>
                                        <option value="<?= $c ?>" <?= (($_POST['course'] ?? '') === $c) ? 'selected' : '' ?>>
                                            <?= $c ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="password" name="confirm_password" id="pw2" class="form-control"
                                    placeholder="Re-enter password" oninput="checkPwMatch()" required>
                            </div>
                    ...
                    <div class="field">
                        <label>
                            ...
                            Gmail Address <span class="req">*</span>
                        </label>
                        <div class="input-wrap">
                            <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                    ...
                    <div class="captcha-box">
                        ...
                        <div class="captcha-row">
                            ...
                            <div class="captcha-input-wrap">
                                <input type="number" name="captcha_answer" id="captcha_answer" placeholder="?"
                                    autocomplete="off" required inputmode="numeric" style="padding-left:14px;">
                            </div>
                            <button type="submit" name="regenerate_captcha" value="1" class="captcha-refresh"
